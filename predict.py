...
if __name__ == '__main__':
    ...
    img2 = img #normalize(tiff.imread('data/near/{}.tif'.format(test_id)).transpose([0,1,2]))
    img3 = img #normalize(tiff.imread('data/far/{}.tif'.format(test_id)).transpose([0,1,2]))
    ...
    tiff.imsave('result_x4_SR.tif', (255*mymat).astype('uint8'))
